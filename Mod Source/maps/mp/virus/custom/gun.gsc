...
iPrintlnBold("^1GUN ^5GAME ^2is brought to you by: ^3>>^2VI[^3R^2]US^3<< ^1!");
...
self.gunList[6] = createGun("g36c_mp", false);
self.gunList[7] = createGun("mp5_mp", false);
self.gunList[8] = createGun("mp44_mp", false);
self.gunList[9] = createGun("uzi_mp", false);
...
self.gunList[16] = createGun("p90_mp", false);
self.gunList[17] = createGun("barrett_mp", false);
self.gunList[18] = createGun("skorpion_mp", false);
self.gunList[19] = createGun("m21_mp", false);
